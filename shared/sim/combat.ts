 ...
 * Using `readonly TankState[]` and an indexed for-loop instead of `Iterable<TankState>`
 * eliminates internal array spread overhead and iterator allocations per projectile per tick.
 */
