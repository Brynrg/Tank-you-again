...
- Strengthened `AI_AGENT_UPGRADE_PLAYBOOK.md` for local AI models with a file ownership map, one-ticket-per-commit execution protocol, exact validation gates, and granular task cards for firing, equipment, pickup/drop, maps, progression, reconnect behavior, and visual skin work.
